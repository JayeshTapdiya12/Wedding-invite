    ...
    const lookbook = [
        {
            ...
            location: "Glory By Shrida , Indore",
            time: "3:30 PM | 27 March",
        ...
        {
            function: "Kesariya Balam",
            location: "The Westin, Pushkar",
            time: "9:30 AM | 30 March",
        ...
        {
            function: "Rangilo Pushkar",
            location: "The Westin, Pushkar",
            time: "10:00 AM | 31 March",
            theme: "Pushkar  Holi Party",
            image: "https://res.cloudinary.com/dwsv6ggaa/image/upload/v1772955982/ef5455f7-540c-47be-b6fc-2a08a16d0231_g29vca.jpg"
        },
        {
            function: "Baraat &  Saat Sur, Saat Vachan ",
            location: "The Westin, Pushkar",
            time: "9:00 PM | 31 March",
